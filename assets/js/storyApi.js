$(document).ready(function () {
  ...
  $("#submit_video").on("click", function () {
    ...
    const settings = {
      async: true,
      crossDomain: true,
      url: `https://instagram-media-downloader.p.rapidapi.com/rapid/stories.php?url=${value}`,
      method: "GET",
      headers: {
    ...
    $.ajax(settings)
      ...
      .done(function (response) {
        ...
        <div class="flex justify-center  items-center flex-col">
            ...
            <a id="download-video" class="text-[23px] pt-3 pb-3 rounded-[10px] bg-cyan-500 p-3 cursor-pointer download-video" download
                href="${data.video}"> Tải xuống video</a>
                <br>
